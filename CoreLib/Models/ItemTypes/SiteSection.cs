...
namespace CoreLib.Models.ItemTypes
{
    /// <summary>
    /// <para>Path: /sitecore/templates/User Defined/Item Type/Site Section</para>
    /// <para>Help: </para>
    /// </summary>
    [SitecoreType(TemplateId = "13ee6564-39a0-4758-8c78-df9995393f3f", AutoMap = true)]
    public partial class SiteSection : GlassBase, ISiteSection
    {
        ...
        Glass.Mapper.Sc.Fields.Image Interface.FieldSection.IBanner.BannerImage
        {
            get
            {
        ...
        Glass.Mapper.Sc.Fields.Link Interface.FieldSection.IBanner.BannerLink
        {
            get
            {
                throw new NotImplementedException();
